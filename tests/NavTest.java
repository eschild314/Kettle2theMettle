...
public class NavTest extends LinearOpMode {
    ...
    @Override public void runOpMode() {
        ...
        final float CAMERA_VERTICAL_DISPLACEMENT = 3.5f * mmPerInch;   // eg: Camera is 8 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = 6.0f;     // eg: Camera is ON the robot's center line
